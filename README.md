...
* [PyCrypto](https://www.dlitz.net/software/pycrypto/)  (This package can sometimes be problematic on windows.  It cannot be installed through most package management systems like easy_install pip etc [wtf python community?].  It sometimes must be compiled from source, which sometimes involves more than its worth on windows...  I recommend Googling for pre-compiled binaries of this library if you are on Windows unless you are already very familiar with compiling things in Windows.  Linux folks have it easy on this one, just install with a package manager.)
